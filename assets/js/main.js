...
// 	$.ajax({
// 		method: "POST",
// 		url: "https://formspree.io/mqklqzkl",
// 		data: { name, email, subject, message }
// 	}).then(() => {
// 		const child = document.getElementById("contactForm");
// 		child.innerHTML = "";
// 		// const newEl = document.createElement("p").appendChild(document.createTextNode("Your form was submitted"));
